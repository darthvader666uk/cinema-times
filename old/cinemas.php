						...
						print '<div class="accordion">';
							print '<div class="accord-header"><h3>'.$cinemaTimes->title.'</h3></div>';
								print '<div class="accord-content">';
									...
									$runTimes = getFileContents('http://www.omdbapi.com/?t='.urlencode($cinemaTitleConvert).'&y='.date('Y').'+'.date('Y', strtotime('-1 years')).'+'.'&plot=short&r=json&tomatoes=true',urlencode($cinemaTitleConvert));
