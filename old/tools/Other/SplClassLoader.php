...
class SplClassLoader
{
    ...
    public function loadClass($className)
    {
        ...
        if (null === $this->_namespace || $this->_namespace.$this->_namespaceSeparator === substr($className, 0, strlen($this->_namespace.$this->_namespaceSeparator))) {
            ...
            /**
             * @author Tom Houdmont <tom.houdmont@imaginet.co.uk>
             *
             * Adapted from @gregm's original solution.
             *
             * Update to Imaginet autoloader. When no namespace is found,
             * try autoloading recursively inside the root Classes folder.
             */
            $class_filename = strtolower($className) . '.php';
            $class_root = $this->_includePath !== null ? $this->_includePath . DIRECTORY_SEPARATOR : ROOT . '/classes/';
