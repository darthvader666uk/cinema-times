<html>
	...
	<body>
		...
		<table class="table_Films">
			...
			<tr>
				<td>Add custom runtimes:</td>
				<td><a href="http://nobletyres.com/cinema/times.php" target="_blank">http://nobletyres.com/cinema/times.php</a></td>
			</tr>
			<tr>
				<td>Convert Film title:</td>
				<td><a href="http://nobletyres.com/cinema/convertTitle.php" target="_blank">http://nobletyres.com/cinema/convertTitle.php</a></td>
			</tr>
			<tr>
				<td>OMDB:</td>
...
<?php
		...
		if($results->Runtime == "N/A") {
			...
			foreach($getCustomRuntimes as $runTines){
				$explodeTimes = explode('-',$runTines);
					...
					//print('<pre>');
					//print('<br> Title: ('.$results->Title.') - exploding Title: ('.$explodeTimes[0].')<br>');
					//print_r($explodeTimes);
					//print('</pre>');

				switch($results->Title){
					case (string)$explodeTimes[0]:
			...
			//print('<pre>');
			//print('<br> After Title:<br>');
			//print_r($results>Runtime);
			//print('</pre>');
	...
	function convertTitle($title){
		...
		print("<br> Correct Title: $title <br>");
		return $title;
	}
?>